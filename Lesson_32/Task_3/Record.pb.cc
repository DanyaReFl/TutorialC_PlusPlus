...
PROTOBUF_CONSTEXPR Record::Record(
  ...
  , /*decltype(_impl_.nameorganization_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.activitytype_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.creationyear_)*/0
  , /*decltype(_impl_.activityforeigneconomic_)*/false} {}
...
const uint32_t TableStruct_Record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Record, _impl_.creationyear_),
  PROTOBUF_FIELD_OFFSET(::Record, _impl_.legaladdress_),
  PROTOBUF_FIELD_OFFSET(::Record, _impl_.nameorganization_),
  PROTOBUF_FIELD_OFFSET(::Record, _impl_.activitytype_),
  PROTOBUF_FIELD_OFFSET(::Record, _impl_.activityforeigneconomic_),
  3,
  0,
  1,
  2,
...
const char descriptor_table_protodef_Record_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Record.proto\"\205\001\n\006Record\022\024\n\014creationYea"
  "r\030\001 \002(\005\022\024\n\014legalAddress\030\002 \002(\t\022\030\n\020nameOrg"
  "anization\030\003 \002(\t\022\024\n\014activityType\030\004 \001(\t\022\037\n"
  "\027activityForeignEconomic\030\005 \001(\010"
  ;
static ::_pbi::once_flag descriptor_table_Record_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Record_2eproto = {
    false, false, 150, descriptor_table_protodef_Record_2eproto,
    "Record.proto",
...
class Record::_Internal {
 public:
  ...
  static void set_has_creationyear(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
  static void set_has_legaladdress(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static void set_has_nameorganization(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static void set_has_activitytype(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static void set_has_activityforeigneconomic(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Record::Record(const Record& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.nameorganization_){}
    , decltype(_impl_.activitytype_){}
    , decltype(_impl_.creationyear_){}
    , decltype(_impl_.activityforeigneconomic_){}};
  ...
  _impl_.nameorganization_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.nameorganization_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_nameorganization()) {
    _this->_impl_.nameorganization_.Set(from._internal_nameorganization(), 
      _this->GetArenaForAllocation());
  }
  ...
  ::memcpy(&_impl_.creationyear_, &from._impl_.creationyear_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.activityforeigneconomic_) -
    reinterpret_cast<char*>(&_impl_.creationyear_)) + sizeof(_impl_.activityforeigneconomic_));
...
inline void Record::SharedDtor() {
  ...
  _impl_.nameorganization_.Destroy();
...
// @@protoc_insertion_point(message_clear_start:Record)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _impl_.nameorganization_.ClearNonDefaultToEmpty();
    }
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.creationyear_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.activityforeigneconomic_) -
        reinterpret_cast<char*>(&_impl_.creationyear_)) + sizeof(_impl_.activityforeigneconomic_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _Internal::set_has_creationyear(&has_bits);
          _impl_.creationyear_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          auto str = _internal_mutable_nameorganization();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Record.nameOrganization");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_activityforeigneconomic(&has_bits);
          _impl_.activityforeigneconomic_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Record::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_creationyear(), target);
  }
  ...
  if (cached_has_bits & 0x00000002u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      this->_internal_nameorganization().data(), static_cast<int>(this->_internal_nameorganization().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "Record.nameOrganization");
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_nameorganization(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_activityforeigneconomic(), target);
  }
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Record)
  ...
  if (_internal_has_nameorganization()) {
    ...
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
        this->_internal_nameorganization());
  }

  if (_internal_has_creationyear()) {
    // required int32 creationYear = 1;
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_creationyear());
  }
...
void Record::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_nameorganization(from._internal_nameorganization());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_activitytype(from._internal_activitytype());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.creationyear_ = from._impl_.creationyear_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.activityforeigneconomic_ = from._impl_.activityforeigneconomic_;
    }
...
void Record::InternalSwap(Record* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.nameorganization_, lhs_arena,
      &other->_impl_.nameorganization_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Record, _impl_.activityforeigneconomic_)
      + sizeof(Record::_impl_.activityforeigneconomic_)
      - PROTOBUF_FIELD_OFFSET(Record, _impl_.creationyear_)>(
          reinterpret_cast<char*>(&_impl_.creationyear_),
          reinterpret_cast<char*>(&other->_impl_.creationyear_));
}
